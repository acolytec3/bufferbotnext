...
import type { TestnetAbi, TestnetAbiInterface } from "../TestnetAbi";
...
export class TestnetAbi__factory {
  static readonly abi = _abi;
  static createInterface(): TestnetAbiInterface {
    return new utils.Interface(_abi) as TestnetAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TestnetAbi {
    return new Contract(address, _abi, signerOrProvider) as TestnetAbi;
  }
}
