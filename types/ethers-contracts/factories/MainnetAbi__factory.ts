...
import type { MainnetAbi, MainnetAbiInterface } from "../MainnetAbi";
...
export class MainnetAbi__factory {
  static readonly abi = _abi;
  static createInterface(): MainnetAbiInterface {
    return new utils.Interface(_abi) as MainnetAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MainnetAbi {
    return new Contract(address, _abi, signerOrProvider) as MainnetAbi;
  }
}
